...
[中文 README](https://github.com/RockyWang0521/EasyCore.EFCoreRepository/blob/master/README.MongoDb.md) | [EFCore 中文 README](https://github.com/RockyWang0521/EasyCore.EFCoreRepository/blob/master/README.md)
...
EasyCore.MongoDbRepository provides a feature-rich entity base class EasyCoreEntity, including:
...
EasyCore.MongoDbRepository provides complete repository abstraction and implementation:
...
EasyCore.MongoDbRepository provides a rich set of API methods:
...
#### 🎯 WhereIf Support
EasyCore.MongoDbRepository provides intelligent conditional query support:
...
### 6. 🔍 Data Filters
EasyCore.MongoDbRepository includes two practical built-in data filters:
...
// AddEasyCoreMongoDbRepository attaches the EntityChange interceptor automatically —
// no UseEasyCoreEntityChange call is required.
builder.Services.AddEasyCoreMongoDbRepository();
```
